...
public class EnemyDamageLabel : MonoBehaviour
{
    [Header("Damage Label")]
    [SerializeField] private TMP_Text damageText;
    [SerializeField] private float normalFontSize = 42;
    [SerializeField] private float critFontSize = 52;
    [SerializeField] private Color normalFontColor = Color.red; // Red for enemies
    ...
    private SpawnEnemyDamagePopups _poolManager;
    ...
    public void Initialize(float displayDuration, SpawnEnemyDamagePopups poolManager)
    {
    ...
    public void ShowEnemyDamageLabel(int damage, Vector3 objPosition, bool direction)
    {
        ...
        damageText.enableVertexGradient = false; // No crits, so no gradient
